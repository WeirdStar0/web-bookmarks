...
export const modals = (t: TemplateTranslations) => `
    ...
    <div x-show="showFolderModal" class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50" x-transition.opacity x-cloak>
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md shadow-2xl transform transition-all" @click.away="showFolderModal = false">
            ...
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">${t.modals.location}</label>
    ...
    <div x-show="showBookmarkModal" class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50" x-transition.opacity x-cloak>
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md shadow-2xl transform transition-all" @click.away="showBookmarkModal = false">
            ...
            <div class="space-y-4 mb-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">${t.modals.bookmarkDesc}</label>
                    <input type="text" x-model="newBookmarkDescription" placeholder="${t.modals.descPlaceholder}" class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">${t.modals.location}</label>
                    <div class="relative" @click.away="selectorOpen = false">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md shadow-2xl transform transition-all" @click.away="showSettingsModal = false">
            ...
            <div class="space-y-4 mb-6">
                <div>
                    ...
                    <input type="text" x-model="settingsForm.username" placeholder="${t.modals.leaveEmptyToKeep}" class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">${t.modals.newPassword}</label>
                    <input type="password" x-model="settingsForm.password" placeholder="${t.modals.leaveEmptyToKeep}" class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow">
                </div>
    ...
    <div x-show="showConfirmModal" class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-[80]" x-transition.opacity x-cloak>
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-sm shadow-2xl transform transition-all" @click.away="showConfirmModal = false">
            ...
            <h3 class="text-lg font-bold text-center text-gray-900 dark:text-white mb-2">${t.modals.confirmTitle}</h3>
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button @click="executeConfirm()" :disabled="isOperationPending" :class="{'opacity-50 cursor-not-allowed': isOperationPending}" class="px-5 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 font-medium shadow-md transition-colors">${t.modals.confirm}</button>
            </div>
        </div>
    </div>
`;
